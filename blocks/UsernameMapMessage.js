    ...
    return [
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": `Hey <@${user_id}>! ` + (added_through_setup ? "You've been added to the triage team on GitWave." : '') + " I'm a Slack app that helps you triage issues on your repos right from Slack. \n \n Please click on the button below provide your GitHub username so that I can DM you whenever you are mentioned (@'ed) by someone on your GitHub repos."
                }
            },
            {
                "type": "actions",
